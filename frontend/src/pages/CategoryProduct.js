        ...
        <Row className="py-5  " >
          <Col
            ...
            style={{
              background: "#333",
              borderRadius: "10px",
              height: data.length === 0 ? "100vh" : "max-content",
            }}
          >
            {/**sort by */}
            <div className="">
              <h3 className="text-base uppercase font-medium text-white border-b pb-1 border-slate-300">
                Sort by
              </h3>
          ...
          <Col sm={10}>
            {data.length === 0 ? (
              ...
              <>
                <p className="font-medium text-white text-lg my-2">
